import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, onScopeDispose, watch, computed, toValue, unref, defineComponent, useSlots, h, Fragment, ref, provide, Suspense, nextTick, mergeProps, createElementBlock, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu, defuFn } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/ufo/dist/index.mjs";
...
import { klona } from "/home/ubuntu/way-trades-restore/way-trades-main--main/node_modules/klona/dist/index.mjs";
...
const _routes = [
  {
    name: "v2",
    path: "/v2",
    component: () => import("./_nuxt/v2-DOKE_0mI.js")
  },
  {
    name: "eula",
    path: "/eula",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/eula-CB8OjFZ9.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-7qmzeTTC.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/privacy-BZohEqOw.js")
  },
  {
    name: "cheat-sheet",
    path: "/cheat-sheet",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/cheat-sheet-B77T4dDI.js")
  },
  {
    name: "return-policy",
    path: "/return-policy",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/return-policy-BUcPai3r.js")
  },
  {
    name: "terms-of-service",
    path: "/terms-of-service",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/terms-of-service-C_YrimIo.js")
  }
];
...
const LazyIcon = defineAsyncComponent(() => import("./_nuxt/index-D3-UHfvc.js").then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Dl6mhdGr.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DkYxgaYc.js"));

...
export declare type ArrayRemove<
  Current extends unknown[],
  Ref extends number | KeyedPathElement,
> = number extends Ref
  ? Current
...
export declare type DropFirst<Array extends unknown[]> = Array extends [
  infer Head,
  ...infer Rest,
]
  ? Rest
...
export declare type RemoveAtIndex<
  Current extends unknown[],
  Index extends number,
> = _RemoveAtIndex<Current, NormalizeIndex<Index, ArrayLength<Current>>>

export declare type _RemoveAtIndex<
  Current extends unknown[],
  Index extends number,
> =

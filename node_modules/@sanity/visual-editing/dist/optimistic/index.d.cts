...
export declare const createDatasetMutator: (comlink: VisualEditingNode) => StateMachine<
    ...
    logic: StateMachine<
      ...
      MetaObject,
      {
        ...
        readonly context: ({
          ...
          client: SanityClient
          sharedListener: Observable<ReconnectEvent | WelcomeEvent | MutationEvent> | undefined
          id: string
          remote: undefined
          local: undefined
          mutationEvents: never[]
  ...
  MetaObject,
  {
    ...
    readonly context: ({
      ...
      documents: {}
      client: SanityClient
      sharedListener: Observable<WelcomeEvent | ReconnectEvent | MutationEvent> | undefined
    }
    readonly on: {
      readonly 'sync': {

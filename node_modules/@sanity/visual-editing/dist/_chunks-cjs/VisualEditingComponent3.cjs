"use strict";
var reactCompilerRuntime = require("react-compiler-runtime"), react = require("@remix-run/react"), react$1 = require("react"), enableVisualEditing = require("./enableVisualEditing.cjs");
function VisualEditingComponent(props) {
  const $ = reactCompilerRuntime.c(20), {
    components,
    refresh,
    zIndex
  } = props, navigateRemix = react.useNavigate(), navigateRemixRef = react$1.useRef(navigateRemix), [navigate, setNavigate] = react$1.useState(), revalidator = react.useRevalidator(), [revalidatorPromise, setRevalidatorPromise] = react$1.useState(null), [revalidatorLoading, setRevalidatorLoading] = react$1.useState(!1);
  let t0, t1;
  $[0] !== navigateRemix ? (t0 = () => {
    navigateRemixRef.current = navigateRemix;
  }, t1 = [navigateRemix], $[0] = navigateRemix, $[1] = t0, $[2] = t1) : (t0 = $[1], t1 = $[2]), react$1.useEffect(t0, t1);
  let t2, t3;
  ...
  }, t3 = [revalidatorLoading, revalidator.state, revalidatorPromise], $[3] = revalidator.state, $[4] = revalidatorLoading, $[5] = revalidatorPromise, $[6] = t2, $[7] = t3) : (t2 = $[6], t3 = $[7]), react$1.useEffect(t2, t3);
  let t4, t5;
  $[8] !== components || $[9] !== refresh || $[10] !== revalidator || $[11] !== zIndex ? (t4 = () => {
    ...
    return () => disable();
  }, t5 = [components, refresh, revalidator, zIndex], $[8] = components, $[9] = refresh, $[10] = revalidator, $[11] = zIndex, $[12] = t4, $[13] = t5) : (t4 = $[12], t5 = $[13]), react$1.useEffect(t4, t5);
  ...
  }, t7 = [location.hash, location.pathname, location.search, navigate], $[14] = location.hash, $[15] = location.pathname, $[16] = location.search, $[17] = navigate, $[18] = t6, $[19] = t7) : (t6 = $[18], t7 = $[19]), react$1.useEffect(t6, t7), null;
}
exports.default = VisualEditingComponent;
//# sourceMappingURL=VisualEditingComponent3.cjs.map

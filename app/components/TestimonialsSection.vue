    ...
    <div class="container mx-auto px-4">
      ...
      <div class="relative">
        ...
        >
          ...
          >
            <div class="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden h-full flex flex-col justify-between hover:border-yellow-500/50 transition-colors">
              <!-- Screenshot Image -->
              ...
              <div class="p-6 flex flex-col justify-between flex-grow">
                ...
                <div class="mb-4">
                  ...
                  <p class="text-yellow-500 text-sm font-bold">{{ testimonial.title }}</p>
                </div>
...
const testimonials = [
  ...
  {
    image: "/testimonial-aftradescash.webp",

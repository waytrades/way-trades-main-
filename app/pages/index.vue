    ...
    <header class="relative py-12 md:py-20 overflow-hidden">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="grid md:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div class="relative">
            <!-- YouTube Video Embed -->
            <div class="relative bg-slate-900 border-2 border-yellow-500/50 rounded-2xl overflow-hidden aspect-video">
              <iframe
                width="100%"
                height="100%"
...
<script setup>
// Nuxt 3 will automatically import the MathematicalSuperiority component
</script>

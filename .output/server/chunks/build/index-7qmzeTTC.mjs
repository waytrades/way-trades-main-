import { defineComponent, mergeProps, toRaw, resolveDirective, useSSRContext } from 'vue';
...
import { a as useSeoMeta } from './v4-CFlShRdU.mjs';
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-cfa2649e><div class="section" data-v-cfa2649e><div${ssrRenderAttrs(mergeProps({ class: "pillars-header" }, ssrGetDirectiveProps(_ctx, _directive_motion, { initial: { opacity: 0, y: 20 }, enter: { opacity: 1, y: 0, transition: { duration: 600 } } })))} data-v-cfa2649e><h2 data-v-cfa2649e>Two Disciplines. One Mathematical Foundation.</h2><p data-v-cfa2649e>We don&#39;t believe in &quot;one size fits all.&quot; Whether you prefer the high-octane execution of intraday futures or the calculated patience of options swings, our BBR framework scales across both.</p></div><div class="pillars-grid" data-v-cfa2649e><div${ssrRenderAttrs(mergeProps({ class: "pillar-card" }, ssrGetDirectiveProps(_ctx, _directive_motion, { initial: { opacity: 0, x: -30 }, enter: { opacity: 1, x: 0, transition: { duration: 600, delay: 200 } } })))} data-v-cfa2649e><div class="pillar-icon" data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:zap" }, null, _parent));
      _push(`</div><h3 data-v-cfa2649e>Futures Day Trading</h3><p class="pillar-description" data-v-cfa2649e>Master the NQ futures markets using intraday order flow and the BBR strategy. We focus on high-probability execution on the 30-second and 5-minute timeframes, specifically designed for prop firm consistency.</p><ul class="pillar-features" data-v-cfa2649e><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>Intraday BBR (Breakouts, Bounces, Rejects)</span></li><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>Order Flow &amp; ICT Execution Concepts</span></li><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>Prop Firm Risk Management Protocols</span></li></ul></div><div${ssrRenderAttrs(mergeProps({ class: "pillar-card" }, ssrGetDirectiveProps(_ctx, _directive_motion, { initial: { opacity: 0, x: 30 }, enter: { opacity: 1, x: 0, transition: { duration: 600, delay: 200 } } })))} data-v-cfa2649e><div class="pillar-icon" data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:trending-up" }, null, _parent));
      _push(`</div><h3 data-v-cfa2649e>Options Swing Trading</h3><p class="pillar-description" data-v-cfa2649e>Build wealth through individual equity options using higher timeframe setups. We utilize bullish divergence and oversold support levels to capture 2-week to 3-month moves with defined risk.</p><ul class="pillar-features" data-v-cfa2649e><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>High-Timeframe BBR Setups</span></li><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>Bullish Divergence &amp; Support Confluence</span></li><li data-v-cfa2649e>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-cfa2649e>Strategic 2-Week to 3-Month Hold Periods</span></li></ul></div></div></div></section>`);
    };
  }
});
...
const PillarsSection = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-cfa2649e"]]), { __name: "V2PillarsSection" });
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Icon = __nuxt_component_1;
      const _directive_motion = resolveDirective("motion");
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "discord-section" }, _attrs))} data-v-a23618a3><div class="section" data-v-a23618a3><div${ssrRenderAttrs(mergeProps({ class: "discord-container" }, ssrGetDirectiveProps(_ctx, _directive_motion, { initial: { opacity: 0, y: 30 }, enter: { opacity: 1, y: 0, transition: { duration: 600 } } })))} data-v-a23618a3><div class="discord-copy" data-v-a23618a3><h2 data-v-a23618a3>The Last Trading Community You&#39;ll Ever Need to Join.</h2><p data-v-a23618a3>Trading is a lonely game, but it doesn&#39;t have to be. Join a room full of practitioners who value risk management over screenshots of P&amp;L.</p><div class="benefits-list" data-v-a23618a3><div class="benefit-item" data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:radio" }, null, _parent));
      _push(`<div data-v-a23618a3><h4 data-v-a23618a3>Live Market Analysis</h4><p data-v-a23618a3>Real-time breakdowns of NQ and Equity setups as they form.</p></div></div><div class="benefit-item" data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:users" }, null, _parent));
      _push(`<div data-v-a23618a3><h4 data-v-a23618a3>Process-Driven Peer Group</h4><p data-v-a23618a3>Surround yourself with traders who care more about R:R than &quot;get rich quick&quot; schemes.</p></div></div><div class="benefit-item" data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:book" }, null, _parent));
      _push(`<div data-v-a23618a3><h4 data-v-a23618a3>The BBR Resource Library</h4><p data-v-a23618a3>Instant access to the core frameworks for both futures and options.</p></div></div></div></div><div class="discord-tiers" data-v-a23618a3><div class="tier-card tier-free" data-v-a23618a3><div class="tier-header" data-v-a23618a3><h3 data-v-a23618a3>Free Tier</h3><p class="tier-price" data-v-a23618a3>$0</p></div><ul class="tier-features" data-v-a23618a3><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Community chat access</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Basic resources &amp; guides</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>General market outlooks</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Peer support &amp; accountability</span></li></ul><p class="tier-description" data-v-a23618a3>A no-brainer for any serious student.</p><a href="https://discord.gg/waytrades" target="_blank" class="btn btn-primary w-full" data-v-a23618a3>Join the Discord</a></div><div class="tier-card tier-mentorship" data-v-a23618a3><div class="tier-badge" data-v-a23618a3>Coming Soon</div><div class="tier-header" data-v-a23618a3><h3 data-v-a23618a3>Mentorship Tier</h3><p class="tier-price" data-v-a23618a3>Premium</p></div><ul class="tier-features" data-v-a23618a3><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>1-on-1 direct access</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Advanced accountability</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Deep-dive execution reviews</span></li><li data-v-a23618a3>`);
      _push(ssrRenderComponent(_component_Icon, { name: "lucide:check" }, null, _parent));
      _push(`<span data-v-a23618a3>Professional-grade coaching</span></li></ul><p class="tier-description" data-v-a23618a3>For traders ready for absolute transformation.</p><button class="btn btn-secondary w-full" disabled data-v-a23618a3>Coming Soon</button></div></div></div><div${ssrRenderAttrs(mergeProps({ class: "trust-microcopy" }, ssrGetDirectiveProps(_ctx, _directive_motion, { initial: { opacity: 0 }, enter: { opacity: 1, transition: { duration: 600, delay: 400 } } })))} data-v-a23618a3><p data-v-a23618a3>Join 5,000+ traders. Access is instant. No credit card required.</p></div></div></section>`);
    };
  }
});
...
const DiscordConversion = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-a23618a3"]]), { __name: "V2DiscordConversion" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "homepage" }, _attrs))} data-v-8ddc82e0>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8ddc82e0"]]);

export { index as default };
//# sourceMappingURL=index-7qmzeTTC.mjs.map

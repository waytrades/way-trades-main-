...
const LazyIcon = defineAsyncComponent(() => import('./index-Dy8173We.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Babpji4E.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-ByuGxPa2.mjs'));

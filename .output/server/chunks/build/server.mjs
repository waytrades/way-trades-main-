import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineAsyncComponent, defineComponent, useSlots, h, Fragment, inject, computed, unref, shallowRef, provide, shallowReactive, createElementBlock, ref, Suspense, createApp, reactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, effectScope, watch, mergeProps, getCurrentScope, toRef, withCtx, nextTick, toValue, onScopeDispose, isReadonly, useSSRContext, isRef, isShallow, isReactive } from 'vue';
import { k as klona, l as parseURL, e as encodePath, m as decodePath, c as createError$1, n as hasProtocol, o as isScriptProtocol, q as joinURL, w as withQuery, r as defuFn, s as sanitizeStatusCode, t as getContext, $ as $fetch$1, v as baseURL, x as defu, y as createHooks, z as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "v2",
    path: "/v2",
    component: () => import('./v2-DOKE_0mI.mjs')
  },
  {
    name: "eula",
    path: "/eula",
    meta: __nuxt_page_meta$4 || {},
    component: () => import('./eula-CB8OjFZ9.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-7qmzeTTC.mjs')
  },
  {
    name: "privacy",
    path: "/privacy",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./privacy-BZohEqOw.mjs')
  },
  {
    name: "cheat-sheet",
    path: "/cheat-sheet",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./cheat-sheet-B77T4dDI.mjs')
  },
  {
    name: "return-policy",
    path: "/return-policy",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./return-policy-BUcPai3r.mjs')
  },
  {
    name: "terms-of-service",
    path: "/terms-of-service",
    meta: __nuxt_page_meta || {},
    component: () => import('./terms-of-service-C_YrimIo.mjs')
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./index-D3-UHfvc.mjs').then((r) => r["default"] || r.default || r));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dl6mhdGr.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DkYxgaYc.mjs'));
...
export { _export_sfc as _, useRouter as a, useNuxtApp as b, nuxtLinkDefaults as c, useAppConfig as d, entry_default as default, encodeRoutePath as e, asyncDataDefaults as f, createError as g, navigateTo as n, resolveRouteObject as r, useRuntimeConfig as u };

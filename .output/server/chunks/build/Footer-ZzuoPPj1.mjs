...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative w-full min-h-screen bg-slate-950 overflow-hidden flex items-center" }, _attrs))} data-v-ec0e1d40><div class="absolute inset-0 overflow-hidden" data-v-ec0e1d40><div class="absolute -top-40 -right-40 w-80 h-80 bg-green-500/20 rounded-full blur-3xl animate-pulse" data-v-ec0e1d40></div><div class="absolute -bottom-40 -left-40 w-80 h-80 bg-green-500/10 rounded-full blur-3xl animate-pulse" style="${ssrRenderStyle({ "animation-delay": "1s" })}" data-v-ec0e1d40></div></div><div class="relative z-10 w-full" data-v-ec0e1d40><div class="max-w-6xl mx-auto px-4 py-20 md:py-32" data-v-ec0e1d40><div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" data-v-ec0e1d40><div${ssrRenderAttrs(mergeProps({
        initial: { opacity: 0, x: -30 },
        enter: { opacity: 1, x: 0, transition: { duration: 800 } },
        class: "space-y-8"
      }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-ec0e1d40><h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tight text-center sm:text-left" data-v-ec0e1d40> You Don&#39;t Need a <span class="text-green-500" data-v-ec0e1d40>High Win Rate</span> to Become Profitable. </h1><p class="text-lg sm:text-xl md:text-2xl text-gray-300 leading-relaxed max-w-lg text-center sm:text-left mx-auto sm:mx-0" data-v-ec0e1d40> Built around risk:reward, expectancy, and disciplined execution — not gambling. </p><div class="space-y-4 pt-4" data-v-ec0e1d40><div class="flex items-start gap-4" data-v-ec0e1d40><div class="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-1" data-v-ec0e1d40><svg class="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-ec0e1d40><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" data-v-ec0e1d40></path></svg></div><span class="text-gray-300" data-v-ec0e1d40>50% win rate with 1:3 risk:reward = consistent profitability</span></div><div class="flex items-start gap-4" data-v-ec0e1d40><div class="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-1" data-v-ec0e1d40><svg class="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-ec0e1d40><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" data-v-ec0e1d40></path></svg></div><span class="text-gray-300" data-v-ec0e1d40>Join traders applying the math daily in live markets</span></div><div class="flex items-start gap-4" data-v-ec0e1d40><div class="w-6 h-6 rounded-full bg-green-500/20 flex items-center justify-center flex-shrink-0 mt-1" data-v-ec0e1d40><svg class="w-4 h-4 text-green-500" fill="currentColor" viewBox="0 0 20 20" data-v-ec0e1d40><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" data-v-ec0e1d40></path></svg></div><span class="text-gray-300" data-v-ec0e1d40>Free Discord community with live trading sessions</span></div></div><div class="flex flex-col sm:flex-row gap-4 pt-8" data-v-ec0e1d40><a href="https://whop.com/waytrades/vip-access-60-1cb2/" target="_blank" class="inline-flex items-center justify-center px-8 py-4 bg-green-500 hover:bg-green-600 text-slate-950 font-black rounded-full transition-all transform hover:scale-105 shadow-lg hover:shadow-green-500/50 duration-300" data-v-ec0e1d40> Start 5-Day Free Trial <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ec0e1d40><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" data-v-ec0e1d40></path></svg></a><a href="https://www.youtube.com/playlist?list=PLeVBW5ryrKoLEQVel4Ld0XjMOPYbj7zOt" target="_blank" class="inline-flex items-center justify-center px-8 py-4 border-2 border-gray-600 hover:border-green-500 text-white font-black rounded-full transition-all duration-300 hover:bg-green-500/10" data-v-ec0e1d40> Watch Trade Recaps </a></div><div class="pt-4 text-center sm:text-left text-sm text-gray-500 font-medium" data-v-ec0e1d40> Free access. No credit card required. </div></div><div${ssrRenderAttrs(mergeProps({
        initial: { opacity: 0, y: 30 },
        enter: { opacity: 1, y: 0, transition: { duration: 800, delay: 200 } },
        class: "relative w-full flex items-center justify-center mt-12 lg:mt-0"
      }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-ec0e1d40><div class="relative w-full max-w-lg" data-v-ec0e1d40><div class="absolute inset-0 bg-gradient-to-br from-green-500/20 to-transparent rounded-2xl blur-3xl" data-v-ec0e1d40></div><div class="relative bg-slate-900/80 backdrop-blur-xl border border-green-500/30 rounded-2xl overflow-hidden shadow-2xl" data-v-ec0e1d40><div class="aspect-video w-full bg-slate-800 relative" data-v-ec0e1d40><iframe src="https://www.youtube.com/embed/RZkAQ7HU-38?autoplay=0&amp;controls=1&amp;modestbranding=1" loading="lazy" class="absolute inset-0 w-full h-full border-0" allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture" allowfullscreen data-v-ec0e1d40></iframe></div><div class="p-6 bg-slate-900/50" data-v-ec0e1d40><div class="flex items-center justify-between mb-4" data-v-ec0e1d40><h3 class="text-sm font-bold text-gray-400 uppercase tracking-widest" data-v-ec0e1d40>Session Performance</h3><span class="px-2 py-1 bg-green-500/10 text-green-500 text-[10px] font-bold rounded border border-green-500/20" data-v-ec0e1d40>VERIFIED MATH</span></div><div class="grid grid-cols-2 gap-8" data-v-ec0e1d40><div class="space-y-1" data-v-ec0e1d40><p class="text-xs text-gray-500 font-medium" data-v-ec0e1d40>Win Rate</p><div class="flex items-baseline gap-1" data-v-ec0e1d40><span class="text-3xl font-black text-white" data-v-ec0e1d40>44</span><span class="text-lg font-bold text-green-500" data-v-ec0e1d40>%</span></div></div><div class="space-y-1" data-v-ec0e1d40><p class="text-xs text-gray-500 font-medium" data-v-ec0e1d40>Risk:Reward</p><div class="flex items-baseline gap-1" data-v-ec0e1d40><span class="text-lg font-bold text-green-500" data-v-ec0e1d40>1:</span><span class="text-3xl font-black text-white" data-v-ec0e1d40>5.4</span></div></div></div><div class="mt-6 pt-6 border-t border-white/5" data-v-ec0e1d40><p class="text-[11px] text-gray-500 italic leading-relaxed mb-6" data-v-ec0e1d40> &quot;You don&#39;t need to be right most of the time. You just need to be right when it matters.&quot; </p><a href="https://whop.com/waytrades/free-access-c6/" target="_blank" class="flex items-center justify-center w-full py-3 bg-green-500/10 hover:bg-green-500/20 text-green-500 font-bold rounded-xl border border-green-500/20 transition-all duration-300 group" data-v-ec0e1d40> JOIN FREE DISCORD `);
      _push(ssrRenderComponent(_component_Icon, {
        name: "lucide:chevron-right",
...
const HeroSection = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-ec0e1d40"]]), { __name: "V2HeroSection" });
const _sfc_main$1 = {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</a></div><div class="flex flex-wrap justify-center gap-4 text-gray-600 text-xs mb-4"><span>© 2026 Way Trades. All rights reserved.</span><span class="hidden md:inline">|</span>`);
...
//# sourceMappingURL=Footer-ZzuoPPj1.mjs.map
